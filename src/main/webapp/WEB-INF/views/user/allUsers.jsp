        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <td>${user.password}</td>
                    <td>
                        <a href="/user/info/show/${user.userId}" type="button" class="btn btn-sm btn-success">详情</a>
                        <a href="/user/info/update/${user.userId}" type="button" class="btn btn-sm btn-warning">修改</a>
                        <a href="/user/info/delete/${user.userId}" type="button" class="btn btn-sm btn-danger">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
